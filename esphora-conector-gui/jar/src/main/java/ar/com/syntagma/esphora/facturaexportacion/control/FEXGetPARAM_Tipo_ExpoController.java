...
public class FEXGetPARAM_Tipo_ExpoController {
	...
	public void ejecutarConsulta(String cuit) {
		...
		fexResponseTex = port.fexGetPARAMTipoExpo(Long.parseLong(cuit.trim()));
		
		// llama a la clase FEXMensajeDeError para validar el mensaje de Error.
		FEXMensajeDeError.ejecutarMensajeDeError(fexResponseTex.getFEXErr() , fexResponseTex.getFEXEvents(), facesMessages);
	}
