...
public class FEXGetPARAM_IncotermsController {
	...
	public void ejecutarConsulta(String cuit) {
		...
		fexResponseInc = port.fexGetPARAMIncoterms(Long.parseLong(cuit.trim()));
		
		// llama a la clase FEXMensajeDeError para validar el mensaje de Error.
		FEXMensajeDeError.ejecutarMensajeDeError(fexResponseInc.getFEXErr() , fexResponseInc.getFEXEvents(), facesMessages);
