...
@Name("feParamGetTiposCbte")
public class FEParamGetTiposCbte implements Serializable {
	/**
	 * 
	 */
	...
	public void ejecutarConsulta(String cuit) {
		...
		cbteTipoResponse = port.feParamGetTiposCbte(Long.parseLong(cuit.trim()));
		
		// llama a la clase FEMensajeDeError para validar el mensaje de Error.
		FEMensajeDeError.ejecutarMensajeDeError(cbteTipoResponse.getErrors(), cbteTipoResponse.getEvents(), facesMessages);
