...
public class FEParamGetTiposMoneda implements Serializable{
	...
	public void ejecutarConsulta(String cuit) {
		...
		monedaResponse = port.feParamGetTiposMonedas(Long.parseLong(cuit.trim()));
		
		// llama a la clase FEMensajeDeError para validar el mensaje de Error.
		FEMensajeDeError.ejecutarMensajeDeError(monedaResponse.getErrors(), monedaResponse.getEvents(), facesMessages);
