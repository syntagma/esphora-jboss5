...
public class FEParamGetTiposOpcional implements Serializable{
	...
	public void ejecutarConsulta(String cuit) {
		...
		opcionalTipoResponse = port.feParamGetTiposOpcional(Long.parseLong(cuit.trim()));
		
		// llama a la clase FEMensajeDeError para validar el mensaje de Error.
		FEMensajeDeError.ejecutarMensajeDeError(opcionalTipoResponse.getErrors(), opcionalTipoResponse.getEvents(), facesMessages);
