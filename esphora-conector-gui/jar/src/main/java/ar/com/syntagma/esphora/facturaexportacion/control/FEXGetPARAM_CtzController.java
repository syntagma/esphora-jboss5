...
public class FEXGetPARAM_CtzController {
	...
	public void ejecutarConsulta(String cuit) {
		...
		fexResponseCtz = port.fexGetPARAMCtz(idMoneda, Long.parseLong(cuit.trim()));
		
		// llama a la clase FEXMensajeDeError para validar el mensaje de Error.
		FEXMensajeDeError.ejecutarMensajeDeError(fexResponseCtz.getFEXErr() , fexResponseCtz.getFEXEvents(), facesMessages);
	}
