...
public class FEXCheck_PermisoController {
	...
	public void ejecutarConsulta(String cuit) {
		...
		fexResponseCheckPermiso = port.fexCheckPermiso(idPermiso, dstMerc, Long.parseLong(cuit.trim()));
		
		// llama a la clase FEXMensajeDeError para validar el mensaje de Error.
		FEXMensajeDeError.ejecutarMensajeDeError(fexResponseCheckPermiso.getFEXErr(), fexResponseCheckPermiso.getFEXEvents(), facesMessages);
	}
