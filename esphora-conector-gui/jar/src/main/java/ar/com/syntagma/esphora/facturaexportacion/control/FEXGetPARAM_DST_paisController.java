...
public class FEXGetPARAM_DST_paisController {
	...
	public void ejecutarConsulta(String cuit) {
		...
		fexResponseDSTPais = port.fexGetPARAMDSTPais(Long.parseLong(cuit.trim()));
		
		// llama a la clase FEXMensajeDeError para validar el mensaje de Error.
		FEXMensajeDeError.ejecutarMensajeDeError(fexResponseDSTPais.getFEXErr() , fexResponseDSTPais.getFEXEvents(), facesMessages);
