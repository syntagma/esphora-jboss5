...
public class FEXGetPARAM_UMedController {
	...
	public void ejecutarConsulta(String cuit) {
		...
		fexResponseUmed = port.fexGetPARAMUMed(Long.parseLong(cuit.trim()));
		
		// llama a la clase FEXMensajeDeError para validar el mensaje de Error.
		FEXMensajeDeError.ejecutarMensajeDeError(fexResponseUmed.getFEXErr() , fexResponseUmed.getFEXEvents(), facesMessages);
	}
