...
public class FEXGetPARAM_DST_CUITController {
	...
	public void ejecutarConsulta(String cuit) {
		...
		fexResponseDSTCuit = port.fexGetPARAMDSTCUIT(Long.parseLong(cuit.trim()));
		
		// llama a la clase FEXMensajeDeError para validar el mensaje de Error.
		FEXMensajeDeError.ejecutarMensajeDeError(fexResponseDSTCuit.getFEXErr() , fexResponseDSTCuit.getFEXEvents(), facesMessages);
	}
