...
public class FEXGetPARAM_IdiomasController {
	...
	public void ejecutarConsulta(String cuit) {
		...
		fexResponseIdi = port.fexGetPARAMIdiomas(Long.parseLong(cuit.trim()));
		
		// llama a la clase FEXMensajeDeError para validar el mensaje de Error.
		FEXMensajeDeError.ejecutarMensajeDeError(fexResponseIdi.getFEXErr() , fexResponseIdi.getFEXEvents(), facesMessages);
