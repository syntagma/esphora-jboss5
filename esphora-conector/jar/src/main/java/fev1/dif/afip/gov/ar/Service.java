    ...
    extends javax.xml.ws.Service
{
    ...
    private final static Logger logger = Logger.getLogger(fev1.dif.afip.gov.ar.Service.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = fev1.dif.afip.gov.ar.Service.class.getResource(".");
            url = new URL(baseUrl, "https://servicios1.afip.gov.ar/wsfev1/service.asmx?WSDL");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'https://servicios1.afip.gov.ar/wsfev1/service.asmx?WSDL', retrying as a local file");
    ...
    public Service() {
        super(SERVICE_WSDL_LOCATION, new QName("http://ar.gov.afip.dif.FEV1/", "Service"));
    }
